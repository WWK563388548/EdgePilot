...
>
> This document is retained for historical traceability only. The current product direction is `docs/product_strategy_v1_1.md`.
...
Historical PRD/TDD and implementation contracts were tracked in this document set.
The full original v0.9 research document remains archived at `docs/reference/edgepilot_prd_tdd_v0_9_full.md` for traceability.

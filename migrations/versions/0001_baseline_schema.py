...
def downgrade() -> None:
    ...
    op.execute("DROP TABLE IF EXISTS trades_journal")
    op.execute("DROP TABLE IF EXISTS exit_alerts")
    op.execute("DROP TABLE IF EXISTS positions")
    op.execute("DROP TABLE IF EXISTS candidates")
    op.execute("DROP TABLE IF EXISTS market_context_snapshots")
    op.execute("DROP TABLE IF EXISTS options_chain_snapshots")

...
def test_analytics_overview_reconciles_journal_close_against_entry_fills(session) -> None:
    principal = _principal()
    session.add(
        db.AccountRiskSettings(
            account_id=principal.account_id,
    ...
    session.add(
        db.Position(
            position_id="pos_imported_entry_manual_close",
            account_id=principal.account_id,
            symbol_id="SPY",
            asset_type="etf",
            strategy_name="etf_rotation_us_etf",
    ...
    session.add(
        db.ExecutionImport(
            import_id="exec_import_manual_close",
            account_id=principal.account_id,
            broker="edgepilot_generic_csv",
            status="completed",
        )
    ...
    session.add(
        db.ExecutionFill(
            fill_id="exec_fill_imported_entry_only",
            import_id="exec_import_manual_close",
            account_id=principal.account_id,
            position_id="pos_imported_entry_manual_close",
            idempotency_key="imported_entry_only",
            broker="edgepilot_generic_csv",
            symbol_id="SPY",
            asset_type="etf",
            side="buy",
    ...
    session.add(
        db.TradeJournal(
            trade_id="trade_imported_entry_manual_close",
            account_id=principal.account_id,
            position_id="pos_imported_entry_manual_close",
            symbol_id="SPY",
            entry_ts=datetime(2026, 5, 1, tzinfo=UTC),
    ...
    assert overview.realized_pnl == 40
    assert overview.unrealized_pnl == 0
    assert overview.total_pnl == 40
...
def test_analytics_overview_excludes_future_buy_fees_from_prior_sell_pnl(session) -> None:
    principal = _principal()
    session.add(
        db.AccountRiskSettings(
            account_id=principal.account_id,
    ...
    session.add(
        db.Position(
            position_id="pos_future_scale_in_fee",
            account_id=principal.account_id,
            symbol_id="SPY",
            asset_type="etf",
            strategy_name="etf_rotation_us_etf",
    ...
    session.add(
        db.ExecutionImport(
            import_id="exec_import_future_scale_in_fee",
            account_id=principal.account_id,
            broker="edgepilot_generic_csv",
            status="completed",
        )
    ...
    session.add_all(
        [
            db.ExecutionFill(
                fill_id="exec_fill_scale_in_initial_buy",
                import_id="exec_import_future_scale_in_fee",
                account_id=principal.account_id,
                position_id="pos_future_scale_in_fee",
                idempotency_key="scale_in_initial_buy",
                broker="edgepilot_generic_csv",
                symbol_id="SPY",
                asset_type="etf",
                side="buy",
            ...
            db.ExecutionFill(
                fill_id="exec_fill_scale_in_sell",
                import_id="exec_import_future_scale_in_fee",
                account_id=principal.account_id,
                position_id="pos_future_scale_in_fee",
                idempotency_key="scale_in_sell",
                broker="edgepilot_generic_csv",
                symbol_id="SPY",
                asset_type="etf",
                side="sell",
            ...
            db.ExecutionFill(
                fill_id="exec_fill_scale_in_future_buy",
                import_id="exec_import_future_scale_in_fee",
                account_id=principal.account_id,
                position_id="pos_future_scale_in_fee",
                idempotency_key="scale_in_future_buy",
                broker="edgepilot_generic_csv",
                symbol_id="SPY",
                asset_type="etf",
                side="buy",
    ...
    assert overview.realized_pnl == 9
    assert overview.trades_count == 1
